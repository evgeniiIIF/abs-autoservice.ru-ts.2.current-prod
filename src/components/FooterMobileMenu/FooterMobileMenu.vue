...
<template>
  <div class="footer-mobile-menu" ref="menuRef">
    <ul class="footer-mobile-menu__list">
      <li v-for="item in items" :key="item.id" class="footer-mobile-menu__item" :class="{ 'footer-mobile-menu__item--active': activeItem === item.id }" @click="onClickItem(item)">
